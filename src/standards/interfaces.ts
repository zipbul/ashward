...
/** One normative citation on a clause/rule: a document, a locator into it, and the requirement level
 *  the clause imposes. A rule carries an array — sources are inherently a set. */
